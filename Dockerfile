...
RUN set -eux ; \
    ...
    curl --retry 10 -S -L -O https://github.com/willsc/Elastic-build/releases/download/v1.0/${tini_bin} ; \
...
RUN curl --retry 10 -S -L --output /tmp/elasticsearch.tar.gz https://github.com/willsc/Elastic-build/releases/download/v1.0/elasticsearch-7.17.4-linux-$(arch).tar.gz
...
LABEL org.label-schema.build-date="2022-05-18T20:11:36.585918371Z" \
